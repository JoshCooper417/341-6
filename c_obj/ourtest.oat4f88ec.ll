...
__fresh2:
  ...
  store i32 43, i32* %vdecl_slot10
  %vdecl_slot11 = alloca i32
  store i32 1720, i32* %vdecl_slot11
  %vdecl_slot12 = alloca i32
  store i32 3440, i32* %vdecl_slot12
  %lhs_or_call13 = load i32* %vdecl_slot12
  %lhs_or_call14 = load i32* %vdecl_slot12
  %bop15 = add i32 %lhs_or_call13, %lhs_or_call14
  %lhs_or_call16 = load i32* %vdecl_slot12
  %bop17 = add i32 %bop15, %lhs_or_call16
  ret i32 %bop17
}
