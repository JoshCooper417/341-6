...
@_const_str5.str. = private unnamed_addr constant [ 7 x i8 ] c "Fields\00", align 4
@_const_str5 = alias bitcast([ 7 x i8 ]* @_const_str5.str. to i8*)@global4 = global i32 0, align 4
